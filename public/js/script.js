const books = [
    ...
    { title: "El principito", category: "infantil", image: "public/images/prince.jpg", synopsis: "Este clásico de la literatura cuenta la historia de un piloto que, tras un accidente en el desierto, conoce a un pequeño príncipe proveniente de otro planeta.", free: true },
    { title: "1984", category: "ficcion", image: "public/images/1984.jpeg", synopsis: "Ambientada en una sociedad distópica, la novela sigue la vida de Winston Smith, un hombre que trabaja para el Partido controlando la información.", free: true },
    { title: "Don Quijote de la Mancha", category: "clasico", image: "public/images/DonQ.jpeg", synopsis: "La historia del caballero Don Quijote y su fiel escudero Sancho Panza en su lucha contra molinos de viento y aventuras desquiciadas.", free: true },
    { title: "Harry Potter y la piedra filosofal", category: "fantasia", image: "public/images/hp.jpeg", synopsis: "Harry Potter descubre que es un mago y comienza su aventura en Hogwarts, donde se enfrenta a la amenaza de Lord Voldemort.", free: false },
    { title: "El hobbit", category: "aventura", image: "public/images/hobbit.jpeg", synopsis: "Bilbo Bolsón emprende un viaje inesperado con un grupo de enanos para recuperar su tesoro de las garras del dragón Smaug.", free: false },
    { title: "Los juegos del hambre", category: "ciencia-ficcion", image: "public/images/jh.jpeg", synopsis: "En un futuro distópico, Katniss Everdeen se convierte en símbolo de la rebelión tras participar en los brutales Juegos del Hambre.", free: false },
    { title: "Orgullo y prejuicio", category: "romance", image: "public/images/pride.jpeg", synopsis: "La historia de Elizabeth Bennet y el orgulloso señor Darcy en una sociedad que valora el matrimonio y la posición social.", free: false },
    { title: "Crónica de una muerte anunciada", category: "novela", image: "public/images/UMA.jpg", synopsis: "La historia reconstruye el asesinato de Santiago Nasar en un pueblo donde todos sabían lo que iba a ocurrir, menos él.", free: false },
    { title: "Drácula", category: "terror", image: "public/images/drac.jpeg", synopsis: "El conde Drácula viaja desde Transilvania a Inglaterra para expandir su reino de terror y enfrentarse al profesor Van Helsing.", free: false },
    { title: "El Camino Del Lobo", category: "hechos-reales", image: "public/images/lobo.jpg", synopsis: "El lobo de Wall Street es la autobiografía de Jordan Belfort, un corredor de bolsa que hizo fortuna con fraudes financieros. Su vida de lujos y excesos terminó cuando el FBI lo atrapó, marcando su caída en Wall Street.", free: true },
    { title: "Hábitos Atómicos", category: "desarrollo-personal", image: "public/images/habitos.jpg", synopsis: "James Clear explica cómo pequeños cambios diarios pueden generar grandes resultados, enseñando estrategias para formar buenos hábitos y eliminar los malos.", free: true },
    { title: "12 Reglas para Vivir", category: "desarrollo-personal", image: "public/images/12reglas.webp", synopsis: "Jordan Peterson presenta 12 principios fundamentales para vivir con propósito y responsabilidad, abordando temas como la autodisciplina, el significado y el orden en la vida.", free: true },
    { title: "El Cuervo", category: "poesia", image: "public/images/cuervo.jpg", synopsis: "Un hombre es visitado por un cuervo que repite 'Nunca más', sumiéndolo en la desesperación y la locura.", free: false }
];
